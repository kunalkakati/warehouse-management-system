...
import { InsertGoodsOutwardInputType } from "@/lib/zod/zod.godown.transaction";
import { FieldConfig } from "./inventory-out.config";
// UI Components
...
interface DynamicFieldProps {
  field: FieldConfig;
  register: UseFormRegister<InsertGoodsOutwardInputType>;
  control: Control<InsertGoodsOutwardInputType>;
  error?: { message?: string };
}

export const DynamicOutField = ({
  field,
  register,
  control,
  error,
